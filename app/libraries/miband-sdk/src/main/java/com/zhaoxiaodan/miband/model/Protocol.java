...
public class Protocol {
    ...
    public static final byte[] START_HEART_RATE_SCAN_CONTINUOUS = {21, 1, 1};
    public static final byte[] STOP_HEART_RATE_SCAN_CONTINUOUS  = {21, 1, 1};
    public static final byte[] START_HEART_RATE_SCAN_MANUAL = {21, 2, 1};
    public static final byte[] STOP_HEART_RATE_SCAN_MANUAL = {21, 2, 1};
